(function () {
    require.config({
        paths: {
            ...
            'angular-nvd3': '../scripts/modules/angular-nvd3',
        ...
        shim: {
            ...
            'd3': {exports: 'd3'},
            'angular-nvd3': {deps: ['angular', 'nvd3']},
            'nvd3': { deps: ['d3']},
    ...
    require(['mifosXComponents.6c51aba3', 'mifosXStyles.276f2ddb'], function (componentsInit) {
